        ...
        <div className ="card" style = {{ boxShadow: "0 1px 7px 0 rgb(0 0 0 / 50%)"}}>
            <div className ="card-body pt-2">
                <div className = "row col-10 offset-1 p-4">
                    <Link to = {`/KimFood/menuItemDetails/${props.menuItem.id}`}>
                    <img src = {props.menuItem.image}
                    ...
                    {props.menuItem.specialTag && props.menuItem.specialTag.length>0&&(<i className = "bi bi-star btn btn-success"
                    style ={{
                        position: "absolute",
                        top: "15px",
                        left: "15px",
                ...
                {isAddingToCart?(
                    ...
                    <i className = "bi bi-cart-plus btn btn-outline-danger" style ={{
                        ...
                        outline: "none !important",
                        cursor: "pointer",
                    }} onClick={() => handleAddToCart(props.menuItem.id)}></i>
                )}

                
                
                <div className = "text-center">
                    <p className ="card-title m-0 text-success fs-3"><Link to = {`/KimFood/menuItemDetails/${props.menuItem.id}`} 
                        style = {{textDecoration:"none", color: 'green'}}>{props.menuItem.name}</Link></p>
